...
const Contact = () => {
  return (
    <div>
      ...
      <div className="my-10 flex flex-col justigy-center md:flex-row gap-10 mb-28 text-sm">
        ...
        flex flex-col justify-center items-start gap-6">
          ...
          <p className="text-gray-600  font-semibold text-lg">CAREERS AT MedThrive360</p>
